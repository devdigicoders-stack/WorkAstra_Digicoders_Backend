...
export const submitOnboardingForm = async (req, res) => {
    try {
        ...
        const formDataToSave = {
            ...
            isDobDifferent: data.isDobDifferent === "true" || data.isDobDifferent === true,
            aadharDateOfBirth: (data.isDobDifferent === "true" || data.isDobDifferent === true) ? data.aadharDateOfBirth : null,
            cvFile,
